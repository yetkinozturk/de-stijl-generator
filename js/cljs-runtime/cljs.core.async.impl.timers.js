...
var i_14592 = (self__.level + (1));
while(true){
if((i_14592 <= (new_level + (1)))){
(update[i_14592] = self__.header);

var G__14596 = (i_14592 + (1));
i_14592 = G__14596;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_14597 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14597[i]));
} else {
x__$2.forward.push((((i < links_14597.length))?(links_14597[i]):null));
}

if((i < links_14597.length)){
(links_14597[i] = x__$2);
} else {
links_14597.push(x__$2);
}
...
var i_14609 = (0);
while(true){
if((i_14609 <= self__.level)){
var links_14610 = (update[i_14609]).forward;
if((x__$1 === (((i_14609 < links_14610.length))?(links_14610[i_14609]):null))){
(links_14610[i_14609] = (x__$1.forward[i_14609]));

var G__14612 = (i_14609 + (1));
i_14609 = G__14612;
continue;
} else {
var G__14613 = (i_14609 + (1));
i_14609 = G__14613;
continue;
}
} else {
